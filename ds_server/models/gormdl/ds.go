...
type DsUserBasicinfo struct {
	...
	Gender        uint8     `gorm:"column:gender;type:tinyint(3) unsigned zerofill;not null" json:"gender"` // 性别：0:男，1:女
...
type DsUserMemberAccount struct {
	...
	CreateTime time.Time `gorm:"column:create_time;type:datetime;not null" json:"create_time"`           // 创建时间
	UpdateTime time.Time `gorm:"column:update_time;type:datetime;not null" json:"update_time"`           // 更新时间
	Ispwd      uint8     `gorm:"column:ispwd;type:tinyint(3) unsigned zerofill;not null" json:"ispwd"`   // 密码是否为空
}
...
type DsUserMemberAgent struct {
	...
	MemclassSelf uint8     `gorm:"column:memclass_self;type:tinyint(3) unsigned zerofill;not null" json:"memclass_self"` // 会员等级
...
type DsUserMemberDepositHistory struct {
	...
	DepositType  uint8     `gorm:"column:deposit_type;type:tinyint(3) unsigned zerofill;not null" json:"deposit_type"` // 充值类型 0:扣款,1:充值
