...
type InfoService interface {
	...
	GetVideoDetail(ctx context.Context, in *VideoDetailReq, opts ...client.CallOption) (*video.Video, error)
...
func (c *infoService) GetVideoDetail(ctx context.Context, in *VideoDetailReq, opts ...client.CallOption) (*video.Video, error) {
...
type InfoHandler interface {
	...
	GetVideoDetail(context.Context, *VideoDetailReq, *video.Video) error
...
func RegisterInfoHandler(s server.Server, hdlr InfoHandler, opts ...server.HandlerOption) error {
	type info interface {
		...
		GetVideoDetail(ctx context.Context, in *VideoDetailReq, out *video.Video) error
...
func (h *infoHandler) GetVideoDetail(ctx context.Context, in *VideoDetailReq, out *video.Video) error {
