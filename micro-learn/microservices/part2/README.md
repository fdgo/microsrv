...
```bash
micro new --namespace=fred.micro.shop --type=srv --alias=auth github.com/wangmhgo/microservice-project/go-micro-learn/microservices/part2/auth
```
...
var (
    ...
    tokenExpiredTopic = "fred.micro.shop.topic.auth.tokenExpired"
)
// Subject token 持有者
type Subject struct {
    ID   string `json:"id"`
...
func Init() {
    serviceClient = us.NewService("fred.micro.shop.srv.user", client.DefaultClient)
...
[micro-new]: https://github.com/wangmhgo/microservice-project/go-micro-learn/examples/tree/master/middle-practices/micro-new
