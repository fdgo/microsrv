...
func init() {
	proto.RegisterType((*Request)(nil), "fred.micro.shop.srv.orders.Request")
	proto.RegisterType((*Order)(nil), "fred.micro.shop.srv.orders.Order")
	proto.RegisterType((*Response)(nil), "fred.micro.shop.srv.orders.Response")
	proto.RegisterType((*Error)(nil), "fred.micro.shop.srv.orders.Error")
}
